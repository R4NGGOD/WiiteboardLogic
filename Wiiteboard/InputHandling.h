...
public:
	...
	static const std::array<bool, 4> LEFT_CLICK_DOWN_NIBBLE;
	static const std::array<bool, 4> LEFT_CLICK_UP_NIBBLE;
	static const std::array<bool, 4> RIGHT_CLICK_DOWN_NIBBLE;
	static const std::array<bool, 4> RIGHT_CLICK_UP_NIBBLE;
	static const std::array<bool, 4> MOUSE_DISCONNECT_NIBBLE;
	~InputHandling();
private:
